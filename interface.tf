...
variable "labels" {
  ...
  validation {
    condition     = var.labels.tribe == "ancillaries" || var.labels.tribe == "autobooking" || var.labels.tribe == "bass" || var.labels.tribe == "bi" || var.labels.tribe == "booking" || var.labels.tribe == "cs-systems" || var.labels.tribe == "data-acquisition" || var.labels.tribe == "finance" || var.labels.tribe == "platform" || var.labels.tribe == "reservations" || var.labels.tribe == "search"
    error_message = "Label tribe is mandatory and can be (ancillaries|autobooking|bass|bi|booking|cs-systems|data-acquisition|finance|platform|reservations|search)."
  }
}
